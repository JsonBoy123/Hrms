...
class LeavesController extends Controller
{
  ...
  */
    ...
    $allotment = LeaveAllotment::with('leaves')
                  ...
                  ->get();
    $leavests = LeaveMast::first();

    return view('employee.leaves.create', compact('reports_to', 'allotment', 'leavests'));
  }
  ...
  public function balance(Request $request){
   ...
   public function store(Request $request)
   {
    ...
    $reports = User::where('id', $request->reports_to)->first();

    $status = $reports->hasRole('hrms_hr') || $reports->hasRole('hrms_admin') ? 4 : 0;
    ...
    $leaveapply->teamlead_approval = $status;
    $leaveapply->save();
