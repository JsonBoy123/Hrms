...
class LoanRequestController extends Controller
{
    ...
    public function testIndex(){
        ...
        $requests = request_test::with(['loanType'])
                        ->where('user_id', Auth::id())->get();

        return view('loan.requests.test-index', compact('requests'));
    }
    ...
    public function testCreate(){
        ...
        return view('loan.requests.test-create', compact('emp', 'types', 'interest'));
    }
    ...
    public function testStore(Request $request)
    {
        ...
        request_test::create([
            ...
            'posted'                    => date("m-j-Y"),
            'interest_rate'             => $request->interest_rate,
            'emi'                       => $request->monthly_deduction,
            'expected_tenure'           => $request->tenure,
            'unit_interest_expected'    => $request->unit_interest,
            'total_interest_expected'   => $request->total_interest,
            'total_amount_expected'     => $request->total_amount,
            ]);

        return redirect()->route('test.index')->with('success', 'Applied for loan succesfully.');
    }
}
