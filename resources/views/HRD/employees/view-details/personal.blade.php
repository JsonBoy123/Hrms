  		...
  		{{-- <div class="col-md-12"> --}}
    		{{-- <div class="tile"> --}}
                ...
                <div class="row mb-6">
				 ...
				 <div class="row mb-6">
	                <div class="col">
	                  	<span style="font-size: 20px; font-weight: bold"><i style="font-size: 15px;" class="fa fa-trash"></i> DELETE USER</span>
	                </div>
           		</div><hr>
				   
	           		<div class="row col-12">
	                	<div class="col-6 form-group">
							<label for=""><b>Delete User(still user info will be available): </b></label>
							<!-- <button type="button" value="1" class="btn btn-primary btn-md" id="vacatedEmp"><span class="fa fa-trash"></span>DELETE</button> -->
							<a class="btn btn-md btn-danger" href=""
                                  onclick="event.preventDefault();
                                                document.getElementById('deleteUser-form').submit();"><i class="fa fa-trash fa-lg"></i> Delete User</a></li>   
                              <form id="deleteUser-form" action="" method="POST" style="display: none;">
                                  @csrf
                              </form>
						</div>            
                 </div>
