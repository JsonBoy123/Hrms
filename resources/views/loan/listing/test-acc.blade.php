                ...
                <td class='text-center' style="border-bottom:none">
                  @if($index->accountant_approval == 0)
                    <span class="ml-2">
                      ...
                      <a href="{{route('test.edit',$index->id)}}" class="btn btn-sm btn-info"><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                    </span>
                  @elseif($index->accountant_approval == 1)
                      <span class="ml-2">
                        <a href="{{route('test.edit',$index->id)}}" class="btn btn-sm btn-info"><i class="fa fa-flickr" aria-hidden="true"></i> History</a>
                      </span>
                  @endif
                </td>
              </tr>
