	...
	<div style=" padding: 1.5rem; border: 1px solid white;background: white">
		{{-- <div class="col-md-12 col-xl-12"> --}}
			<h1 style="font-size: 24px">Apply for Loan
				<a href="{{ route('test.index') }}" class="btn btn-sm btn-primary pull-right"  style="{background-color: #e7e7e7; color: black;}" >Go Back</a>
		</h1>
		{{-- </div> --}}
		...
		<form action="{{route('test.store')}}" method="POST" id="loanRequest">
			@csrf
			...
			<div class="row">
				...
				<div class="col-6 form-group ">
					...
					<input type="hidden" class="form-control" name="unit_interest" value="" id="unit_interest">
