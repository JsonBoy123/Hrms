...
//Route::get('/hrms-log', 'HomeController@homeHrms')->name('login');
Auth::routes(['register' => false]);


/****Testing Loan****/

Route::get('/test-index', 'loan\LoanRequestController@testIndex')->name('test.index');
Route::get('/test-create', 'loan\LoanRequestController@testCreate')->name('test.create');
Route::post('/test-store', 'loan\LoanRequestController@testStore')->name('test.store');

/**** testing leave allotment ****/
Route::get('/test-leave_allotment', 'HRD\LeavesController@leaveAllotmenttest')->name('test.leave_allotment');


/*Accounts*/
Route::get('/test-listing', 'loan\LoanListingController@testListingAcc')->name('test.listing');
Route::get('test-edit/{id}', 'loan\LoanListingController@testEdit')->name('test.edit');

Route::post('test-edit-store/{id}', 'loan\LoanListingController@testEditStore')->name('edit.store');
Route::post('/test-disburse/{id}', 'loan\LoanListingController@testDisburse')->name('disburse-store');
/*HR*/
Route::get('/test-hr', 'loan\LoanListingController@testHr')->name('test-hr');
Route::get('/test-history/{id}', 'loan\LoanListingController@testHistory')->name('test-history');

/*History*/

Route::post('test-history/{id}', 'loan\LoanListingController@testHistoryStore')->name('test-history.store');
/*EMI*/

Route::post('test-delete-emi/{id}', 'loan\LoanListingController@testDestroyEmi')->name('test-emi.del');

/*Update Loan*/

Route::get('test-update-emi/{id}', 'loan\LoanListingController@testUpdateEmi')->name('test-emi.update');
...
Route::post('update-avatar', 'InformationController@updateAvatar')->name('update-avatar');
...
Route::group(['middleware' => ['role:hrms_admin|hrms_hr|hrms_subadmin']], function() {
	...
	Route::prefix('hrd')->namespace('HRD')->group(function () {
		...
		// Route::get('/employees/delete-per-user/{id}','EmployeesController@deleteUserPermanent')->name('delete-user.perm');

		Route::resource('vacated-users', 'VacatedUserController')->only(['index', 'destroy']);
		// Route::post('/vacated-users/{id}/delete', 'VacatedUserController@destroy')->name('vacated-user.index');
	...
	#Route::group(['middleware' => ['ability:hrms_admin, leave_management']], function(){
		...
		Route::get('/leave-management/rules', 'HRD\LeavesController@indexRules')->name('rules.index');
		Route::post('/leave-management/rules', 'HRD\LeavesController@activateRules')->name('rules.activate');
		Route::get('leave-management/add-employees', 'HRD\LeavesController@RulesEmployees')->name('rules.employees');
		Route::post('leave-management/add-employees', 'HRD\LeavesController@storeRulesEmployees')->name('rules.employees.store');
		Route::post('leave-management/rule-employees-destroy/{id}', 'HRD\LeavesController@destroyRulesEmployees')->name('rule.employees.destroy');
